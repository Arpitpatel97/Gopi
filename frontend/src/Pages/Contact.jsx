          ...
          <Title text1={'CONTACT'} text2={'US'}/> 
            ...
            <div  className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
               ...
               <div className='flex flex-col justify-center items-start gap-6'>
                ...
                <p className='text-gray-500'>208025 <br />Yashoda Nagar, Kanpur(behind patel traders and Balaji electronics)</p>
                <p className='text-gray-500'>Tel: +91-6005675120 <br />Email:admin@gopi.com</p>

                <p className='font-semibold text-xl text-gray-600'>Careers at Gopi</p>
